			...
			name("SystemdServiceSection"): {
				ObjectTypeSpec: schema.ObjectTypeSpec{
					...
					Properties: map[string]schema.PropertySpec{
						...
						"environment":  props.ArrayOf("string", ""),
						...
						"restartSec": props.Integer("Configures the time to sleep before restarting a service (as configured with Restart=)."),
						"type": {
