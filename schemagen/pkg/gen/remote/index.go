...
func Generate(commandSpec schema.PackageSpec) schema.PackageSpec {
	...
	resources := map[string]schema.ResourceSpec{
		...
		name("KubeApiServerService"):         generateKubeApiServerService(commandSpec),
		name("KubeApiServerConfiguration"):   generateKubeApiServerConfiguration(commandSpec),
		...
		name("StartEtcd"):                    generateStartEtcd(commandSpec),
