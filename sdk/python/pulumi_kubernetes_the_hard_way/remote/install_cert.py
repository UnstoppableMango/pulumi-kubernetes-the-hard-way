...
def install_cert(connection: Optional[pulumi.InputType['_root_inputs.Connection']] = None,
    ...
    :param pulumi.InputType['_tls.KeyPair'] keypair: The certificate to install at the remote location.
    ...
    __ret__ = pulumi.runtime.invoke('kubernetes-the-hard-way:remote:installCert', __args__, opts=opts, typ=InstallCertResult).value
...
def install_cert_output(connection: Optional[pulumi.Input[pulumi.InputType['_root_inputs.Connection']]] = None,
