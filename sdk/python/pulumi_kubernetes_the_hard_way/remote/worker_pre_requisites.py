...
class WorkerPreRequisites(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'WorkerPreRequisites':
        """
        ...
        return WorkerPreRequisites(resource_name, opts=opts, __props__=__props__)
