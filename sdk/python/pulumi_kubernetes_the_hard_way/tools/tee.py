...
class TeeArgs:
    def __init__(__self__, *,
                 ...
                 lifecycle: Optional[Union[pulumi.Input['CommandLifecycle'], pulumi.Input[Sequence[pulumi.Input['CommandLifecycle']]]]] = None,
        ...
        :param Union[pulumi.Input['CommandLifecycle'], pulumi.Input[Sequence[pulumi.Input['CommandLifecycle']]]] lifecycle: At what stage(s) in the resource lifecycle should the command be run.
    ...
    @property
    @pulumi.getter
    def lifecycle(self) -> Optional[Union[pulumi.Input['CommandLifecycle'], pulumi.Input[Sequence[pulumi.Input['CommandLifecycle']]]]]:
        """
    ...
    @lifecycle.setter
    def lifecycle(self, value: Optional[Union[pulumi.Input['CommandLifecycle'], pulumi.Input[Sequence[pulumi.Input['CommandLifecycle']]]]]):
