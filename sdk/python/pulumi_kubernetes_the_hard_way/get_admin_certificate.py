...
__all__ = [
    'GetAdminCertificateResult',
    'AwaitableGetAdminCertificateResult',
    'get_admin_certificate',
    'get_admin_certificate_output',
]
...
class AwaitableGetAdminCertificateResult(GetAdminCertificateResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetAdminCertificateResult(
            cert=self.cert)
...
def get_admin_certificate(algorithm: Optional[str] = None,
                          ...
                          opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetAdminCertificateResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('kubernetes-the-hard-way:index:getAdminCertificate', __args__, opts=opts, typ=GetAdminCertificateResult).value

    return AwaitableGetAdminCertificateResult(
        cert=pulumi.get(__ret__, 'cert'))


@_utilities.lift_output_func(get_admin_certificate)
def get_admin_certificate_output(algorithm: Optional[pulumi.Input[Optional[str]]] = None,
                                 allowed_uses: Optional[pulumi.Input[Sequence[str]]] = None,
                                 dns_names: Optional[pulumi.Input[Optional[Sequence[str]]]] = None,
                                 early_renewal_hours: Optional[pulumi.Input[Optional[int]]] = None,
                                 ecdsa_curve: Optional[pulumi.Input[Optional[str]]] = None,
                                 ...
                                 subject: Optional[pulumi.Input[Optional[pulumi.InputType['pulumi_tls.CertRequestSubjectArgs']]]] = None,
                                 uris: Optional[pulumi.Input[Optional[Sequence[str]]]] = None,
                                 validity_period_hours: Optional[pulumi.Input[int]] = None,
                                 opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetAdminCertificateResult]:
    """
    Creates a Certificate configured for the cluster admin.
