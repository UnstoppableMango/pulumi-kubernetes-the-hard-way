...
def new_certificate(algorithm: Optional['Algorithm'] = None,
                    ...
                    subject: Optional[pulumi.InputType['_root_inputs.CertRequestSubject']] = None,
    ...
    __ret__ = pulumi.runtime.invoke('kubernetes-the-hard-way:tls:newCertificate', __args__, opts=opts, typ=NewCertificateResult).value
...
def new_certificate_output(algorithm: Optional[pulumi.Input['Algorithm']] = None,
                           ...
                           subject: Optional[pulumi.Input[Optional[pulumi.InputType['_root_inputs.CertRequestSubject']]]] = None,
