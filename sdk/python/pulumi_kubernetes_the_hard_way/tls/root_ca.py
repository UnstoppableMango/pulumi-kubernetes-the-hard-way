...
class RootCa(pulumi.ComponentResource):
    ...
    def install_cert(__self__, *,
        ...
        __args__['path'] = path
        __result__ = pulumi.runtime.call('kubernetes-the-hard-way:tls:RootCa/installCert', __args__, res=__self__, typ=RootCa.InstallCertResult)
    ...
    def install_key(__self__, *,
        ...
        __args__['options'] = options
        __args__['path'] = path
        __result__ = pulumi.runtime.call('kubernetes-the-hard-way:tls:RootCa/installKey', __args__, res=__self__, typ=RootCa.InstallKeyResult)
        return __result__.result
    ...
    def new_certificate(__self__, *,
                        ...
                        set_authority_key_id: Optional[pulumi.Input[bool]] = None,
                        set_subject_key_id: Optional[pulumi.Input[bool]] = None,
                        subject: Optional[pulumi.Input['_root_inputs.CertRequestSubjectArgs']] = None,
        ...
        __args__['uris'] = uris
        __result__ = pulumi.runtime.call('kubernetes-the-hard-way:tls:RootCa/newCertificate', __args__, res=__self__, typ=RootCa.NewCertificateResult)
        return __result__.result
