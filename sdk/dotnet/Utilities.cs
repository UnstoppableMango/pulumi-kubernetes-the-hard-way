...
namespace UnMango.KubernetesTheHardWay
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("UnMango.KubernetesTheHardWay.version.txt");
    ...
    internal sealed class KubernetesTheHardWayResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public KubernetesTheHardWayResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
