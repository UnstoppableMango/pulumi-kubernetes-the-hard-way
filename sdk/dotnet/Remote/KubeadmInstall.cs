...
namespace UnMango.KubernetesTheHardWay.Remote
{
    ...
    /// </summary>
    [KubernetesTheHardWayResourceType("kubernetes-the-hard-way:remote:KubeadmInstall")]
    public partial class KubeadmInstall : global::Pulumi.ComponentResource
    {
        /// <summary>
        ...
        /// <summary>
        /// Create a KubeadmInstall resource with the given unique name, arguments, and options.
        /// </summary>
        ///
        /// <param name="name">The unique name of the resource</param>
        /// <param name="args">The arguments used to populate this resource's properties</param>
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public KubeadmInstall(string name, KubeadmInstallArgs args, ComponentResourceOptions? options = null)
            : base("kubernetes-the-hard-way:remote:KubeadmInstall", name, args ?? new KubeadmInstallArgs(), MakeResourceOptions(options, ""), remote: true)
        {
        }
    ...
    public sealed class KubeadmInstallArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// The CPU architecture to install.
        /// </summary>
        ...
        public KubeadmInstallArgs()
        {
            Directory = "/usr/local/bin";
        }
        public static new KubeadmInstallArgs Empty => new KubeadmInstallArgs();
    }
}
