...
namespace UnMango.KubernetesTheHardWay.Remote
{
    public static class InstallControlPlane
    {
        ...
        public static Task InvokeAsync(InstallControlPlaneArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync("kubernetes-the-hard-way:remote:installControlPlane", args ?? new InstallControlPlaneArgs(), options.WithDefaults());
    }
