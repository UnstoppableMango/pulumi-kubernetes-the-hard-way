...
namespace UnMango.KubernetesTheHardWay.Remote
{
    ...
    /// </summary>
    [KubernetesTheHardWayResourceType("kubernetes-the-hard-way:remote:KubeApiServerInstall")]
    public partial class KubeApiServerInstall : global::Pulumi.ComponentResource
    {
        /// <summary>
        ...
        /// </summary>
        [Output("mv")]
        public Output<UnMango.KubernetesTheHardWay.Tools.Outputs.Mv> Mv { get; private set; } = null!;
        ...
        /// </summary>
        [Output("rm")]
        public Output<UnMango.KubernetesTheHardWay.Tools.Outputs.Rm> Rm { get; private set; } = null!;
        ...
        public KubeApiServerInstall(string name, KubeApiServerInstallArgs args, ComponentResourceOptions? options = null)
            : base("kubernetes-the-hard-way:remote:KubeApiServerInstall", name, args ?? new KubeApiServerInstallArgs(), MakeResourceOptions(options, ""), remote: true)
        {
        }
    ...
    public sealed class KubeApiServerInstallArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// The CPU architecture to install.
        /// </summary>
