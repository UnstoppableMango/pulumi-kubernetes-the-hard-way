...
namespace UnMango.KubernetesTheHardWay.Remote
{
    ...
    /// </summary>
    [KubernetesTheHardWayResourceType("kubernetes-the-hard-way:remote:KubeProxyService")]
    public partial class KubeProxyService : global::Pulumi.ComponentResource
    {
        /// <summary>
        /// Kubelet configuration.
        /// </summary>
        [Output("configuration")]
        public Output<Outputs.KubeProxyConfigurationProps> Configuration { get; private set; } = null!;
        ...
        /// <summary>
        /// Create a KubeProxyService resource with the given unique name, arguments, and options.
        /// </summary>
        ///
        /// <param name="name">The unique name of the resource</param>
        /// <param name="args">The arguments used to populate this resource's properties</param>
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public KubeProxyService(string name, KubeProxyServiceArgs args, ComponentResourceOptions? options = null)
            : base("kubernetes-the-hard-way:remote:KubeProxyService", name, args ?? new KubeProxyServiceArgs(), MakeResourceOptions(options, ""), remote: true)
        {
        }
    ...
    public sealed class KubeProxyServiceArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Kubelet configuration.
        /// </summary>
        [Input("configuration", required: true)]
        public Input<Inputs.KubeProxyConfigurationPropsArgs> Configuration { get; set; } = null!;
        ...
        public KubeProxyServiceArgs()
        {
        }
        public static new KubeProxyServiceArgs Empty => new KubeProxyServiceArgs();
    }
}
