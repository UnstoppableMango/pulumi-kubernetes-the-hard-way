...
namespace UnMango.KubernetesTheHardWay.Remote
{
    ...
    /// </summary>
    [KubernetesTheHardWayResourceType("kubernetes-the-hard-way:remote:EtcdService")]
    public partial class EtcdService : global::Pulumi.ComponentResource
    {
        ...
        public EtcdService(string name, EtcdServiceArgs args, ComponentResourceOptions? options = null)
            : base("kubernetes-the-hard-way:remote:EtcdService", name, args ?? new EtcdServiceArgs(), MakeResourceOptions(options, ""), remote: true)
        {
        }
    ...
    public sealed class EtcdServiceArgs : global::Pulumi.ResourceArgs
    {
        ...
        public EtcdServiceArgs()
        {
        }
        public static new EtcdServiceArgs Empty => new EtcdServiceArgs();
    }
}
