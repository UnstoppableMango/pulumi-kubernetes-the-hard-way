...
namespace UnMango.KubernetesTheHardWay.Remote
{
    ...
    public partial class ContainerdInstall : global::Pulumi.ComponentResource
    {
        ...
        public ContainerdInstall(string name, ContainerdInstallArgs args, ComponentResourceOptions? options = null)
            : base("kubernetes-the-hard-way:remote:ContainerdInstall", name, args ?? new ContainerdInstallArgs(), MakeResourceOptions(options, ""), remote: true)
        {
        }
    ...
    public sealed class ContainerdInstallArgs : global::Pulumi.ResourceArgs
    {
        ...
        public ContainerdInstallArgs()
        {
            Directory = "/usr/local/bin";
        }
        public static new ContainerdInstallArgs Empty => new ContainerdInstallArgs();
    }
}
