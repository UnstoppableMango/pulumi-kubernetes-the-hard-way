...
namespace UnMango.KubernetesTheHardWay.Remote
{
    ...
    /// </summary>
    [KubernetesTheHardWayResourceType("kubernetes-the-hard-way:remote:KubectlInstall")]
    public partial class KubectlInstall : global::Pulumi.ComponentResource
    {
        /// <summary>
        ...
        public KubectlInstall(string name, KubectlInstallArgs args, ComponentResourceOptions? options = null)
            : base("kubernetes-the-hard-way:remote:KubectlInstall", name, args ?? new KubectlInstallArgs(), MakeResourceOptions(options, ""), remote: true)
        {
        }
    ...
    public sealed class KubectlInstallArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// The CPU architecture to install.
        /// </summary>
        ...
        public KubectlInstallArgs()
        {
            Directory = "/usr/local/bin";
        }
        public static new KubectlInstallArgs Empty => new KubectlInstallArgs();
    }
}
