...
namespace UnMango.KubernetesTheHardWay.Tls
{
    ...
    public partial class RootCa : global::Pulumi.ComponentResource
    {
        ...
        public global::Pulumi.Output<UnMango.KubernetesTheHardWay.Remote.File> InstallCert(RootCaInstallCertArgs args)
            => global::Pulumi.Deployment.Instance.Call<RootCaInstallCertResult>("kubernetes-the-hard-way:tls:RootCa/installCert", args ?? new RootCaInstallCertArgs(), this).Apply(v => v.Result);

        /// <summary>
        /// Creates a RemoteFile resource representing the copy operation.
        /// </summary>
        public global::Pulumi.Output<UnMango.KubernetesTheHardWay.Remote.File> InstallKey(RootCaInstallKeyArgs args)
            => global::Pulumi.Deployment.Instance.Call<RootCaInstallKeyResult>("kubernetes-the-hard-way:tls:RootCa/installKey", args ?? new RootCaInstallKeyArgs(), this).Apply(v => v.Result);

        /// <summary>
        /// Creates a Certificate configured for the current authority.
        /// </summary>
        public global::Pulumi.Output<UnMango.KubernetesTheHardWay.Tls.Certificate> NewCertificate(RootCaNewCertificateArgs args)
            => global::Pulumi.Deployment.Instance.Call<RootCaNewCertificateResult>("kubernetes-the-hard-way:tls:RootCa/newCertificate", args ?? new RootCaNewCertificateArgs(), this).Apply(v => v.Result);
    }
    ...
    internal sealed class RootCaNewCertificateResult
    {
        ...
        [OutputConstructor]
        private RootCaNewCertificateResult(UnMango.KubernetesTheHardWay.Tls.Certificate result)
        {
            Result = result;
        }
    }
