...
namespace UnMango.KubernetesTheHardWay.Config.Inputs
{
    ...
    /// {{% /examples %}}
    /// </summary>
    public sealed class PodManifestArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("status")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Core.V1.PodStatusArgs>? Status { get; set; }

        public PodManifestArgs()
        {
        }
        public static new PodManifestArgs Empty => new PodManifestArgs();
    }
}
