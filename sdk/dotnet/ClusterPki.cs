...
{
    [KubernetesTheHardWayResourceType("kubernetes-the-hard-way:index:ClusterPki")]
    public partial class ClusterPki : global::Pulumi.ComponentResource
    {
        ...
        /// </summary>
        [Output("admin")]
        public Output<UnMango.KubernetesTheHardWay.Certificate> Admin { get; private set; } = null!;

        /// <summary>
        /// Name of the algorithm to use when generating the private key.
        /// </summary>
        [Output("algorithm")]
        public Output<UnMango.KubernetesTheHardWay.Algorithm> Algorithm { get; private set; } = null!;

        [Output("ca")]
        public Output<UnMango.KubernetesTheHardWay.RootCa> Ca { get; private set; } = null!;
        ...
        public Output<UnMango.KubernetesTheHardWay.Certificate> ControllerManager { get; private set; } = null!;

        /// <summary>
        /// The kube proxy certificate.
        /// </summary>
        [Output("kubeProxy")]
        public Output<UnMango.KubernetesTheHardWay.Certificate> KubeProxy { get; private set; } = null!;

        /// <summary>
        /// The kube scheduler certificate.
        /// </summary>
        [Output("kubeScheduler")]
        public Output<UnMango.KubernetesTheHardWay.Certificate> KubeScheduler { get; private set; } = null!;

        /// <summary>
        /// Map of node name to kubelet certificate.
        /// </summary>
        [Output("kubelet")]
        public Output<ImmutableDictionary<string, UnMango.KubernetesTheHardWay.Certificate>> Kubelet { get; private set; } = null!;

        /// <summary>
        /// The kubernetes certificate.
        /// </summary>
        [Output("kubernetes")]
        public Output<UnMango.KubernetesTheHardWay.Certificate> Kubernetes { get; private set; } = null!;
        ...
        public Output<UnMango.KubernetesTheHardWay.Certificate> ServiceAccounts { get; private set; } = null!;
        ...
        public ClusterPki(string name, ClusterPkiArgs args, ComponentResourceOptions? options = null)
            : base("kubernetes-the-hard-way:index:ClusterPki", name, args ?? new ClusterPkiArgs(), MakeResourceOptions(options, ""), remote: true)
        {
        }
    ...
    public sealed class ClusterPkiArgs : global::Pulumi.ResourceArgs
    {
        ...
        {
            Algorithm = UnMango.KubernetesTheHardWay.Algorithm.RSA;
            RsaBits = 2048;
