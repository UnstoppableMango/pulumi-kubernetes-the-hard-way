...
{
    [KubernetesTheHardWayResourceType("kubernetes-the-hard-way:index:Certificate")]
    public partial class Certificate : global::Pulumi.ComponentResource
    {
        ...
        public Certificate(string name, CertificateArgs args, ComponentResourceOptions? options = null)
            : base("kubernetes-the-hard-way:index:Certificate", name, args ?? new CertificateArgs(), MakeResourceOptions(options, ""), remote: true)
        {
        }
