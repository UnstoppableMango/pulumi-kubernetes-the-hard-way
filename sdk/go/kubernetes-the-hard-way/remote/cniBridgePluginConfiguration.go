...
type CniBridgePluginConfiguration struct {
	...
	// IPAM
	Ipam CniBridgeIpamOutput `pulumi:"ipam"`
	// Is gateway.
...
// Bridge name.
func (o CniBridgePluginConfigurationOutput) Bridge() pulumi.StringOutput {
	return o.ApplyT(func(v *CniBridgePluginConfiguration) pulumi.StringOutput { return v.Bridge }).(pulumi.StringOutput)
}

// CNI version.
func (o CniBridgePluginConfigurationOutput) CniVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *CniBridgePluginConfiguration) pulumi.StringOutput { return v.CniVersion }).(pulumi.StringOutput)
}

// The parameters with which to connect to the remote host.
func (o CniBridgePluginConfigurationOutput) Connection() pulumiCommand.ConnectionOutput {
...
// IPAM
func (o CniBridgePluginConfigurationOutput) Ipam() CniBridgeIpamOutput {
	return o.ApplyT(func(v *CniBridgePluginConfiguration) CniBridgeIpamOutput { return v.Ipam }).(CniBridgeIpamOutput)
}

// Is gateway.
func (o CniBridgePluginConfigurationOutput) IsGateway() pulumi.BoolOutput {
	return o.ApplyT(func(v *CniBridgePluginConfiguration) pulumi.BoolOutput { return v.IsGateway }).(pulumi.BoolOutput)
}
...
// CNI plugin type.
func (o CniBridgePluginConfigurationOutput) Type() pulumi.StringOutput {
	return o.ApplyT(func(v *CniBridgePluginConfiguration) pulumi.StringOutput { return v.Type }).(pulumi.StringOutput)
}
