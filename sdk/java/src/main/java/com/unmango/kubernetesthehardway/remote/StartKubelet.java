...
import com.unmango.kubernetesthehardway.remote.StartKubeletArgs;
 ...
 * 
 */
@ResourceType(type="kubernetes-the-hard-way:remote:StartKubelet")
public class StartKubelet extends com.pulumi.resources.ComponentResource {
    /**
     ...
     */
    public StartKubelet(String name) {
        this(name, StartKubeletArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public StartKubelet(String name, StartKubeletArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public StartKubelet(String name, StartKubeletArgs args, @Nullable com.pulumi.resources.ComponentResourceOptions options) {
        super("kubernetes-the-hard-way:remote:StartKubelet", name, args == null ? StartKubeletArgs.Empty : args, makeResourceOptions(options, Codegen.empty()), true);
    }
