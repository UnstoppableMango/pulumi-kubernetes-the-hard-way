...
public final class KubeadmInstallArgs extends com.pulumi.resources.ResourceArgs {

    public static final KubeadmInstallArgs Empty = new KubeadmInstallArgs();
    ...
    private KubeadmInstallArgs() {}

    private KubeadmInstallArgs(KubeadmInstallArgs $) {
    ...
    public static Builder builder(KubeadmInstallArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new KubeadmInstallArgs();
        }

        public Builder(KubeadmInstallArgs defaults) {
            $ = new KubeadmInstallArgs(Objects.requireNonNull(defaults));
        }
        ...
        public KubeadmInstallArgs build() {
            if ($.connection == null) {
                throw new MissingRequiredPropertyException("KubeadmInstallArgs", "connection");
            }
