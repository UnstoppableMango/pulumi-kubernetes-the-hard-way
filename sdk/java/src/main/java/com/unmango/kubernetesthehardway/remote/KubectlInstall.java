...
import com.unmango.kubernetesthehardway.remote.KubectlInstallArgs;
 ...
 * 
 */
@ResourceType(type="kubernetes-the-hard-way:remote:KubectlInstall")
public class KubectlInstall extends com.pulumi.resources.ComponentResource {
    /**
     ...
     */
    public KubectlInstall(String name) {
        this(name, KubectlInstallArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public KubectlInstall(String name, KubectlInstallArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public KubectlInstall(String name, KubectlInstallArgs args, @Nullable com.pulumi.resources.ComponentResourceOptions options) {
        super("kubernetes-the-hard-way:remote:KubectlInstall", name, args == null ? KubectlInstallArgs.Empty : args, makeResourceOptions(options, Codegen.empty()), true);
    }
