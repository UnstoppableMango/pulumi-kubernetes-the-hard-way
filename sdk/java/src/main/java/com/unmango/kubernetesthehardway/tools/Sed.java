...
public class Sed extends com.pulumi.resources.CustomResource {
    /**
     ...
     */
    public Sed(String name, SedArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes-the-hard-way:tools:Sed", name, args == null ? SedArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private Sed(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes-the-hard-way:tools:Sed", name, null, makeResourceOptions(options, id));
    }
     ...
     */
    public static Sed get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
