...
import com.unmango.kubernetesthehardway.remote.KubeadmInstallArgs;
 ...
 * 
 */
@ResourceType(type="kubernetes-the-hard-way:remote:KubeadmInstall")
public class KubeadmInstall extends com.pulumi.resources.ComponentResource {
    /**
     ...
     */
    public KubeadmInstall(String name) {
        this(name, KubeadmInstallArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public KubeadmInstall(String name, KubeadmInstallArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public KubeadmInstall(String name, KubeadmInstallArgs args, @Nullable com.pulumi.resources.ComponentResourceOptions options) {
        super("kubernetes-the-hard-way:remote:KubeadmInstall", name, args == null ? KubeadmInstallArgs.Empty : args, makeResourceOptions(options, Codegen.empty()), true);
    }
