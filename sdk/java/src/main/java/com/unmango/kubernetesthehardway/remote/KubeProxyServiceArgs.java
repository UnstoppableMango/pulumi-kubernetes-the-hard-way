...
import com.unmango.kubernetesthehardway.remote.inputs.KubeProxyConfigurationPropsArgs;
...
public final class KubeProxyServiceArgs extends com.pulumi.resources.ResourceArgs {

    public static final KubeProxyServiceArgs Empty = new KubeProxyServiceArgs();
    ...
    private Output<KubeProxyConfigurationPropsArgs> configuration;

    /**
     * @return Kubelet configuration.
     * 
     */
    public Output<KubeProxyConfigurationPropsArgs> configuration() {
    ...
    private KubeProxyServiceArgs() {}

    private KubeProxyServiceArgs(KubeProxyServiceArgs $) {
    ...
    public static Builder builder(KubeProxyServiceArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new KubeProxyServiceArgs();
        }

        public Builder(KubeProxyServiceArgs defaults) {
            $ = new KubeProxyServiceArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder configuration(Output<KubeProxyConfigurationPropsArgs> configuration) {
         ...
         * 
         */
        public Builder configuration(KubeProxyConfigurationPropsArgs configuration) {
        ...
        public KubeProxyServiceArgs build() {
            if ($.configuration == null) {
                throw new MissingRequiredPropertyException("KubeProxyServiceArgs", "configuration");
            }
            if ($.connection == null) {
                throw new MissingRequiredPropertyException("KubeProxyServiceArgs", "connection");
            }
            return $;
        }
    }
