...
import com.unmango.kubernetesthehardway.remote.KubeletInstallArgs;
 ...
 * 
 */
@ResourceType(type="kubernetes-the-hard-way:remote:KubeletInstall")
public class KubeletInstall extends com.pulumi.resources.ComponentResource {
    /**
     ...
     */
    public KubeletInstall(String name) {
        this(name, KubeletInstallArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public KubeletInstall(String name, KubeletInstallArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public KubeletInstall(String name, KubeletInstallArgs args, @Nullable com.pulumi.resources.ComponentResourceOptions options) {
        super("kubernetes-the-hard-way:remote:KubeletInstall", name, args == null ? KubeletInstallArgs.Empty : args, makeResourceOptions(options, Codegen.empty()), true);
    }
