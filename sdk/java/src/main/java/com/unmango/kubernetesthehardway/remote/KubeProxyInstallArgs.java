...
public final class KubeProxyInstallArgs extends com.pulumi.resources.ResourceArgs {

    public static final KubeProxyInstallArgs Empty = new KubeProxyInstallArgs();
    ...
    private KubeProxyInstallArgs() {}

    private KubeProxyInstallArgs(KubeProxyInstallArgs $) {
    ...
    public static Builder builder(KubeProxyInstallArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new KubeProxyInstallArgs();
        }

        public Builder(KubeProxyInstallArgs defaults) {
            $ = new KubeProxyInstallArgs(Objects.requireNonNull(defaults));
        }
        ...
        public KubeProxyInstallArgs build() {
            if ($.connection == null) {
                throw new MissingRequiredPropertyException("KubeProxyInstallArgs", "connection");
            }
