...
import com.unmango.kubernetesthehardway.remote.KubeProxyServiceArgs;
...
import com.unmango.kubernetesthehardway.remote.outputs.KubeProxyConfigurationProps;
 ...
 * 
 */
@ResourceType(type="kubernetes-the-hard-way:remote:KubeProxyService")
public class KubeProxyService extends com.pulumi.resources.ComponentResource {
    /**
     * Kubelet configuration.
     * 
     */
    @Export(name="configuration", refs={KubeProxyConfigurationProps.class}, tree="[0]")
    private Output<KubeProxyConfigurationProps> configuration;

    /**
     * @return Kubelet configuration.
     * 
     */
    public Output<KubeProxyConfigurationProps> configuration() {
     ...
     */
    public KubeProxyService(String name) {
        this(name, KubeProxyServiceArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public KubeProxyService(String name, KubeProxyServiceArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public KubeProxyService(String name, KubeProxyServiceArgs args, @Nullable com.pulumi.resources.ComponentResourceOptions options) {
        super("kubernetes-the-hard-way:remote:KubeProxyService", name, args == null ? KubeProxyServiceArgs.Empty : args, makeResourceOptions(options, Codegen.empty()), true);
    }
