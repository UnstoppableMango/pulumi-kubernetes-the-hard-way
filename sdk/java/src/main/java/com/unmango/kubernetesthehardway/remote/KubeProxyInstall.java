...
import com.unmango.kubernetesthehardway.remote.KubeProxyInstallArgs;
 ...
 * 
 */
@ResourceType(type="kubernetes-the-hard-way:remote:KubeProxyInstall")
public class KubeProxyInstall extends com.pulumi.resources.ComponentResource {
    /**
     ...
     */
    public KubeProxyInstall(String name) {
        this(name, KubeProxyInstallArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public KubeProxyInstall(String name, KubeProxyInstallArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public KubeProxyInstall(String name, KubeProxyInstallArgs args, @Nullable com.pulumi.resources.ComponentResourceOptions options) {
        super("kubernetes-the-hard-way:remote:KubeProxyInstall", name, args == null ? KubeProxyInstallArgs.Empty : args, makeResourceOptions(options, Codegen.empty()), true);
    }
