...
import com.unmango.kubernetesthehardway.config.CniBridgePluginConfigurationArgs;
 ...
 * 
 */
@ResourceType(type="kubernetes-the-hard-way:config:CniBridgePluginConfiguration")
public class CniBridgePluginConfiguration extends com.pulumi.resources.ComponentResource {
    @Export(name="result", refs={com.unmango.kubernetesthehardway.config.outputs.CniBridgePluginConfiguration.class}, tree="[0]")
    private Output<com.unmango.kubernetesthehardway.config.outputs.CniBridgePluginConfiguration> result;

    public Output<com.unmango.kubernetesthehardway.config.outputs.CniBridgePluginConfiguration> result() {
        return this.result;
    }
    /**
    ...
    public CniBridgePluginConfiguration(String name, CniBridgePluginConfigurationArgs args, @Nullable com.pulumi.resources.ComponentResourceOptions options) {
        super("kubernetes-the-hard-way:config:CniBridgePluginConfiguration", name, args == null ? CniBridgePluginConfigurationArgs.Empty : args, makeResourceOptions(options, Codegen.empty()), true);
    }
