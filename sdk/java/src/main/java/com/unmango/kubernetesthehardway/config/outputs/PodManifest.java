...
@CustomType
public final class PodManifest {
    /**
    ...
    public static Builder builder(PodManifest defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable PodStatus status;
        public Builder() {}
        public Builder(PodManifest defaults) {
        ...
        public PodManifest build() {
            final var _resultValue = new PodManifest();
