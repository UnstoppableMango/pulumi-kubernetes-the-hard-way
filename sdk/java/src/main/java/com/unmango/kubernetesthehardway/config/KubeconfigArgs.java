...
public final class KubeconfigArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public KubeconfigArgs build() {
            ...
            if ($.clientCert == null) {
                throw new MissingRequiredPropertyException("KubeconfigArgs", "clientCert");
            }
            if ($.clientKey == null) {
                throw new MissingRequiredPropertyException("KubeconfigArgs", "clientKey");
            }
            if ($.clusterName == null) {
                throw new MissingRequiredPropertyException("KubeconfigArgs", "clusterName");
            }
            if ($.server == null) {
                throw new MissingRequiredPropertyException("KubeconfigArgs", "server");
            }
            if ($.username == null) {
                throw new MissingRequiredPropertyException("KubeconfigArgs", "username");
            }
            return $;
        }
    }
