...
public final class KubeletInstallArgs extends com.pulumi.resources.ResourceArgs {

    public static final KubeletInstallArgs Empty = new KubeletInstallArgs();
    ...
    private KubeletInstallArgs() {}

    private KubeletInstallArgs(KubeletInstallArgs $) {
    ...
    public static Builder builder(KubeletInstallArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new KubeletInstallArgs();
        }

        public Builder(KubeletInstallArgs defaults) {
            $ = new KubeletInstallArgs(Objects.requireNonNull(defaults));
        }
        ...
        public KubeletInstallArgs build() {
            if ($.connection == null) {
                throw new MissingRequiredPropertyException("KubeletInstallArgs", "connection");
            }
