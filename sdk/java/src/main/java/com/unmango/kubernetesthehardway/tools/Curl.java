...
import com.unmango.kubernetesthehardway.tools.outputs.CurlOpts;
...
public class Curl extends com.pulumi.resources.CustomResource {
    /**
     ...
     * 
     */
    @Export(name="create", refs={CurlOpts.class}, tree="[0]")
    private Output</* @Nullable */ CurlOpts> create;

    /**
     * @return The command to run on create.
     * 
     */
    public Output<Optional<CurlOpts>> create() {
     ...
     * 
     */
    @Export(name="delete", refs={CurlOpts.class}, tree="[0]")
    private Output</* @Nullable */ CurlOpts> delete;
     ...
     * 
     */
    public Output<Optional<CurlOpts>> delete() {
     ...
     * 
     */
    @Export(name="update", refs={CurlOpts.class}, tree="[0]")
    private Output</* @Nullable */ CurlOpts> update;
     ...
     * 
     */
    public Output<Optional<CurlOpts>> update() {
     ...
     */
    public Curl(String name, CurlArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes-the-hard-way:tools:Curl", name, args == null ? CurlArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private Curl(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes-the-hard-way:tools:Curl", name, null, makeResourceOptions(options, id));
    }
     ...
     */
    public static Curl get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        return new Curl(name, id, options);
    }
}
