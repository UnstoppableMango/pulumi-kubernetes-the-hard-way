...
public final class KubectlInstallArgs extends com.pulumi.resources.ResourceArgs {

    public static final KubectlInstallArgs Empty = new KubectlInstallArgs();
    ...
    private KubectlInstallArgs() {}

    private KubectlInstallArgs(KubectlInstallArgs $) {
    ...
    public static Builder builder(KubectlInstallArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new KubectlInstallArgs();
        }

        public Builder(KubectlInstallArgs defaults) {
            $ = new KubectlInstallArgs(Objects.requireNonNull(defaults));
        }
        ...
        public KubectlInstallArgs build() {
            if ($.connection == null) {
                throw new MissingRequiredPropertyException("KubectlInstallArgs", "connection");
            }
