...
public class Tee extends com.pulumi.resources.CustomResource {
    /**
     ...
     */
    public Tee(String name, TeeArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes-the-hard-way:tools:Tee", name, args == null ? TeeArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private Tee(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("kubernetes-the-hard-way:tools:Tee", name, null, makeResourceOptions(options, id));
    }
     ...
     */
    public static Tee get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
