...
export class ClusterPki extends pulumi.ComponentResource {
    /** @internal */
    public static readonly __pulumiType = 'kubernetes-the-hard-way:index:ClusterPki';
     ...
     */
    public readonly algorithm!: pulumi.Output<enums.Algorithm>;
...
export interface ClusterPkiArgs {
     ...
     */
    nodes: pulumi.Input<{[key: string]: pulumi.Input<inputs.ClusterPkiNodeArgs>}>;
    /**
