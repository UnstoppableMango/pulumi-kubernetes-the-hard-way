 ...
 */
export class Systemctl extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Systemctl {
        return new Systemctl(name, undefined as any, { ...opts, id: id });
    }
     ...
     */
    constructor(name: string, args: SystemctlArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        super(Systemctl.__pulumiType, name, resourceInputs, opts);
    }
}
