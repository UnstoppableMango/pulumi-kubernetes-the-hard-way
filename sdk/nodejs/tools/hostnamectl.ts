 ...
 */
export class Hostnamectl extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Hostnamectl {
        return new Hostnamectl(name, undefined as any, { ...opts, id: id });
    }
     ...
     */
    constructor(name: string, args: HostnamectlArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        super(Hostnamectl.__pulumiType, name, resourceInputs, opts);
    }
}
...
export interface HostnamectlArgs {
     ...
     * The command to run on create.
     */
    create?: pulumi.Input<inputs.tools.HostnamectlOptsArgs>;
    /**
     * The command to run on delete. The environment variables PULUMI_COMMAND_STDOUT
     * and PULUMI_COMMAND_STDERR are set to the stdout and stderr properties of the
     * Command resource from previous create or update steps.
     */
    delete?: pulumi.Input<inputs.tools.HostnamectlOptsArgs>;
    /**
     * Environment variables
     */
     ...
     * create or update steps.
     */
    update?: pulumi.Input<inputs.tools.HostnamectlOptsArgs>;
}
