 ...
 */
export class KubeProxyService extends pulumi.ComponentResource {
    /** @internal */
    public static readonly __pulumiType = 'kubernetes-the-hard-way:remote:KubeProxyService';

    /**
     * Returns true if the given object is an instance of KubeProxyService.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is KubeProxyService {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === KubeProxyService.__pulumiType;
    }

    /**
     * Kubelet configuration.
     */
    public readonly configuration!: pulumi.Output<outputs.remote.KubeProxyConfigurationProps>;
    /**
     ...
     */
    constructor(name: string, args: KubeProxyServiceArgs, opts?: pulumi.ComponentResourceOptions) {
        ...
        super(KubeProxyService.__pulumiType, name, resourceInputs, opts, true /*remote*/);
    }
}
...
export interface KubeProxyServiceArgs {
     ...
     * Kubelet configuration.
     */
    configuration: pulumi.Input<inputs.remote.KubeProxyConfigurationPropsArgs>;
    /**
     * The parameters with which to connect to the remote host.
     */
