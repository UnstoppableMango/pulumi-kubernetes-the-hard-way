 ...
 */
export class CniPluginConfiguration extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): CniPluginConfiguration {
        return new CniPluginConfiguration(name, undefined as any, { ...opts, id: id });
    }
     ...
     */
    public readonly bridge!: pulumi.Output<outputs.remote.CniBridgePluginConfiguration>;
    /**
     ...
     */
    public readonly loopback!: pulumi.Output<outputs.remote.CniLoopbackPluginConfiguration>;
     ...
     */
    constructor(name: string, args: CniPluginConfigurationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        super(CniPluginConfiguration.__pulumiType, name, resourceInputs, opts);
    }
}
...
export interface CniPluginConfigurationArgs {
     ...
     * The CNI bridge configuration.
     */
    bridge?: pulumi.Input<inputs.remote.CniBridgePluginConfigurationArgs>;
    /**
     * The parameters with which to connect to the remote host.
     */
     ...
     * The CNI loopback configuration.
     */
    loopback?: pulumi.Input<inputs.remote.CniLoopbackPluginConfigurationArgs>;
}
