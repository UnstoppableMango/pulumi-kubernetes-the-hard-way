 ...
 */
export class KubeletService extends pulumi.ComponentResource {
    /** @internal */
    public static readonly __pulumiType = 'kubernetes-the-hard-way:remote:KubeletService';

    /**
     * Returns true if the given object is an instance of KubeletService.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is KubeletService {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === KubeletService.__pulumiType;
    }
     ...
     */
    public readonly configuration!: pulumi.Output<outputs.remote.KubeletConfigurationProps>;
    /**
     ...
     */
    constructor(name: string, args: KubeletServiceArgs, opts?: pulumi.ComponentResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (!opts.id) {
            if ((!args || args.after === undefined) && !opts.urn) {
                throw new Error("Missing required property 'after'");
            }
            ...
            if ((!args || args.requires === undefined) && !opts.urn) {
        ...
        super(KubeletService.__pulumiType, name, resourceInputs, opts, true /*remote*/);
    }
}
...
export interface KubeletServiceArgs {
     ...
     * Kubelet configuration.
     */
    configuration: pulumi.Input<inputs.remote.KubeletConfigurationPropsArgs>;
    /**
     * The parameters with which to connect to the remote host.
     */
