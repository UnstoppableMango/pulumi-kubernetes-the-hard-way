 ...
 */
export class KubeadmInstall extends pulumi.ComponentResource {
    /** @internal */
    public static readonly __pulumiType = 'kubernetes-the-hard-way:remote:KubeadmInstall';

    /**
     * Returns true if the given object is an instance of KubeadmInstall.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is KubeadmInstall {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === KubeadmInstall.__pulumiType;
    }
     ...
     */
    constructor(name: string, args: KubeadmInstallArgs, opts?: pulumi.ComponentResourceOptions) {
        ...
        super(KubeadmInstall.__pulumiType, name, resourceInputs, opts, true /*remote*/);
    }
}
