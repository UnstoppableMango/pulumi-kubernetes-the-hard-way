 ...
 */
export class KubeSchedulerInstall extends pulumi.ComponentResource {
    /** @internal */
    public static readonly __pulumiType = 'kubernetes-the-hard-way:remote:KubeSchedulerInstall';

    /**
     * Returns true if the given object is an instance of KubeSchedulerInstall.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is KubeSchedulerInstall {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === KubeSchedulerInstall.__pulumiType;
    }
    ...
    public /*out*/ readonly download!: pulumi.Output<Download | undefined>;
    public /*out*/ readonly mkdir!: pulumi.Output<Mkdir | undefined>;
    public /*out*/ readonly mktemp!: pulumi.Output<Mktemp | undefined>;
    public /*out*/ readonly mv!: pulumi.Output<Mv | undefined>;
    public /*out*/ readonly path!: pulumi.Output<string | undefined>;
    public /*out*/ readonly rm!: pulumi.Output<Rm | undefined>;
    /**
    ...
    constructor(name: string, args: KubeSchedulerInstallArgs, opts?: pulumi.ComponentResourceOptions) {
        ...
        super(KubeSchedulerInstall.__pulumiType, name, resourceInputs, opts, true /*remote*/);
    }
}
