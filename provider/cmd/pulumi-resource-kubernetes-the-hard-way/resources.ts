...
import { RemoteDownload } from './remote';
...
export type ResourceConstructor = {
  ...
  readonly 'kubernetes-the-hard-way:remote:RemoteDownload': ConstructComponent<RemoteDownload>;
...
const resources: ResourceConstructor = {
  ...
  'kubernetes-the-hard-way:remote:RemoteDownload': (...args) => new RemoteDownload(...args),
